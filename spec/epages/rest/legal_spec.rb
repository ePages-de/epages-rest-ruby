...
describe 'Epages::REST::Categories' do
  ...
  describe 'GET#contact_info' do
    ...
    it 'get the correct response' do
      expect(contact_info).to be_a Epages::Legal
  ...
  describe 'PUT#updata_contact_info' do
    ...
    it 'modifies the contact_info' do
      ...
      # expect(new_contact_info).to be_a Epages::Legal
  ...
  describe 'GET#privacy_policy' do
    ...
    it 'get the correct response' do
      expect(privacy_policy).to be_a Epages::Legal
  ...
  describe 'GET#terms_and_conditions' do
    ...
    it 'get the correct response' do
      expect(terms_and_conditions).to be_a Epages::Legal
  ...
  describe 'GET#rights_of_withdrawal' do
    ...
    it 'get the correct response' do
      expect(rights_of_withdrawal).to be_a Epages::Legal
  ...
  describe 'GET#shipping_info' do
    ...
    it 'get the correct response' do
      expect(shipping_info).to be_a Epages::Legal
